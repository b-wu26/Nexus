...
def create_posts(posts):
    ...
    for post in posts:
        ...
        images = [f"https://uw-nexus-contents.s3.us-east-2.amazonaws.com/{attachment.s3_endpoint}" for attachment in attachments if attachment.s3_endpoint.lower().endswith(('.jpeg', '.jpg', '.png'))]
