...
@post_endpoints.route('/api/posts/<int:post_id>', methods=['DELETE'])
def delete_post(post_id):
    post_object = post.get_post_by_id(post_id)
...
def create_posts(posts):
    ...
    for post in posts:
        ...
        data.append({"id": post.idposts,
            "poster": {"first": poster_profile.f_name, "last": poster_profile.l_name, "id": post.idstudent_profile},
