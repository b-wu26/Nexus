    ...
    <>
        ...
        <div className="card-header">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="ml-2">
                <div className="h5 m-0">@user1</div>
                <div className="h7 text-muted">4th year ECE</div>
              </div>
            </div>
            <div>
              <div className="dropdown">
                ...
                >
                  <div className="h6 dropdown-header">Options</div>
      ...
      <div className="card gedf-card">
        <div className="card-header">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="ml-2">
                <div className="h5 m-0">@user893274</div>
                <div className="h7 text-muted">2nd year CS</div>
              </div>
            </div>
            <div>
              <div className="dropdown">
        ...
        <i className="fa fa-clock-o"></i>10 min ago
          ...
          <div>
            <span className="badge badge-primary">Assignment 3</span>
          </div>
        </div>
        <div className="card-footer">
          <a href="#" className="card-link">
        ...
        <div className="card-header">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="ml-2">
                <div className="h5 m-0">@user627384</div>
                <div className="h7 text-muted">4th year ECE</div>
              </div>
            </div>
            <div>
