    ...
    return(
        <section className="create-post">
            ...
            <div className="submit-btn" ref={showBtn}>
                <button className="btn btn-primary btn-sm" type="submit" ref={btnRef}>Submit</button>
            </div>
            <input type="file" accept="image/*" name="post_image" ref={postPictureBtnRef} className="d-none" />
        </section>
        );
}
